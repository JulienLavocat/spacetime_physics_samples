...
pub mod physics_world_ticks_table;
pub mod physics_world_type;
pub mod player_move_reducer;
pub mod player_shoot_reducer;
pub mod player_spawn_reducer;
pub mod player_type;
...
pub use physics_world_ticks_table::*;
...
pub use player_shoot_reducer::{player_shoot, set_flags_for_player_shoot, PlayerShootCallbackId};
pub use player_spawn_reducer::{player_spawn, set_flags_for_player_spawn, PlayerSpawnCallbackId};
...
pub enum Reducer {
    OnDisconnect,
    PhysicsTick { tick: PhysicsWorldTick },
    PlayerMove { position: Vec3, looking_at: Quat },
    PlayerShoot,
    PlayerSpawn,
}
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            ...
            Reducer::PlayerShoot => "player_shoot",
            Reducer::PlayerSpawn => "player_spawn",
        }
    }
}
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            ...
            "player_shoot" => Ok(
                __sdk::parse_reducer_args::<player_shoot_reducer::PlayerShootArgs>(
                    "player_shoot",
                    &value.args,
                )?
                .into(),
            ...
            "player_spawn" => Ok(
                __sdk::parse_reducer_args::<player_spawn_reducer::PlayerSpawnArgs>(
                    "player_spawn",
                    &value.args,
                )?
                .into(),
...
pub struct DbUpdate {
    ...
    physics_world_ticks: __sdk::TableUpdate<PhysicsWorldTick>,
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                ...
                "physics_world_ticks" => db_update
                    .physics_world_ticks
                    .append(physics_world_ticks_table::parse_table_update(table_update)?),
                "players" => db_update
                    .players
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.physics_world = cache
            ...
            .with_updates_by_pk(|row| &row.id);
        diff.physics_world_ticks = cache
            .apply_diff_to_table::<PhysicsWorldTick>(
                "physics_world_ticks",
                &self.physics_world_ticks,
            )
            .with_updates_by_pk(|row| &row.id);
        diff.players = cache
...
pub struct AppliedDiff<'r> {
    ...
    physics_world_ticks: __sdk::TableAppliedDiff<'r, PhysicsWorldTick>,
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        physics_world_ticks_table::register_table(client_cache);
